// il banner con le opzioni filtro è fatto con un array (composto dalla serie di icone con i loro testi)

// importazione di tutte le icone del banner
import {
    MdOutlineApartment,
    MdHouseSiding,
    MdOutlineWater,
  ...
  // Questo array contiene le label (descrizioni) matchate con le icone 
  ...
  // questo mega array contiene i dati delle cards delle case nella landing page 
